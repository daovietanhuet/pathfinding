              ...
              if (!_this.state.tableValue[successor.index] || _this.state.tableValue[successor.index] > successor.f) {
                _this.setState(function (prev) {
                  ...
                  prev.priorityQueueOpen.map(function (ele, i) {
                    if (ele.index == successor.index) prev.priorityQueueOpen[i] = successor;
                  });
                  prev.priorityQueueOpen.sort(function (a, b) {
                    b.f - a.f;
                  });
                  prev.tableValue[successor.index] = successor.f;
                  console.log(prev.priorityQueueOpen);
                  return {
...
//# sourceMappingURL=index.js.d6af0083404274a27882.hot-update.js.map