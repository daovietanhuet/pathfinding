  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "pathfinding", function () {
      var _loop2 = function _loop2() {
        ...
        for (var _i3 = 0; _i3 < _this.state.priorityQueueOpen[_i3]; _i3++) {
          if (_this.state.priorityQueueOpen[_i3].f < q.f) q = Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this);
        }

        _this.state.priorityQueueOpen.splice(i, 1);

        var x = q.index % 20;
        var y = (q.index - q.index % 20) / 20;
        var successor = {};

        for (var _i4 = x - 1; _i4 < x + 2; _i4++) {
          for (var j = y - 1; j < y + 2; j++) {
            if (_i4 >= 0 && j >= 0 && _i4 < 20 && j < 20) {
              ...
              if (q.index == 300) console.log(successor);
...
//# sourceMappingURL=index.js.379bc733e9580ae1e311.hot-update.js.map