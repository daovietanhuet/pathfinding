          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              _loop2 = function _loop2() {
                ...
                var child = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(_this.state.priorityQueueOpen);

                child = JSON.parse(_this.state.priorityQueueOpen);
                  ...
                  for (var j = y - 1; j < y + 2; j++) {
                    if (_i >= 0 && j >= 0 && _i < 20 && j < 20) {
                      ...
                      if (!_this.state.tableValue[successor.index] || _this.state.tableValue[successor.index] > successor.f) {
                        ...
                        var have = false;
                        child.map(function (value, i) {
                          if (value.index == successor.index) {
                            child[i] = successor;
                            have = true;
                          }
                        });
                        if (!have) child.push(successor);
                ...
                Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this);
              };
...
//# sourceMappingURL=index.js.455ce8b8b80c7538710a.hot-update.js.map