...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "pathfinding", function () {
      var _loop2 = function _loop2() {
        var q = _this.state.priorityQueueOpen.map((value, i));

        var x = q.index % 20;
        var y = (q.index - q.index % 20) / 20;
        var successor = {};

        for (var _i3 = x - 1; _i3 < x + 2; _i3++) {
          for (var j = y - 1; j < y + 2; j++) {
            if (_i3 >= 0 && j >= 0 && _i3 < 20 && j < 20) {
              successor.index = j * 20 + _i3;
              if (successor.index == _this.state.chooseIndex) return {
                v: successor.index
              };
              successor.g = q.g + 1;
              successor.h = Math.sqrt(Math.pow(_i3 - _this.state.chooseIndex % 20, 2) + Math.pow(j - _this.state.chooseIndex / 20, 2));
              successor.f = successor.g + successor.h;
              if (_i3 == x && j == y) console.log(successor);
...
//# sourceMappingURL=index.js.32cd8794b3eee5f723e9.hot-update.js.map