  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "pathfinding", function () {
      var _loop2 = function _loop2() {
        ...
        for (var _i = 0; _i < _this.state.priorityQueueOpen[_i]; _i++) {
          _this.state.priorityQueueOpen.splice(_i, 1);
        }
        ...
        for (var _i2 = x - 1; _i2 < x + 2; _i2++) {
          for (var j = y - 1; j < y + 2; j++) {
            if (_i2 >= 0 && j >= 0 && _i2 < 20 && j < 20) {
              successor.index = j * 20 + _i2;
              if (successor.index == _this.state.chooseIndex) return {
                v: successor.index
              };
              successor.g = q.g + 1;
              successor.h = Math.sqrt(Math.pow(_i2 - _this.state.chooseIndex % 20, 2) + Math.pow(j - _this.state.chooseIndex / 20, 2));
...
//# sourceMappingURL=index.js.813df71a1cdf9731853d.hot-update.js.map