...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "row", function (index) {
      var row = [];
            ...
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_this.setState(function (prev) {
                      prev.tableValue = [];
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "pathfinding", function _callee3() {
      var _loop2, _ret;

      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee3$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _loop2 = function _loop2() {
                var q, x, y, successor, i, j;
                return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _loop2$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        q = void 0;
                        _context3.next = 3;
                        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_this.state.priorityQueueOpen.map(function (value, i) {}));
                      ...
                      case 14:
                        ...
                        if (i == x && j == y) console.log(successor);
                              ...
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  case 0:
                                    ...
                                    _context2.next = 5;
                                    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(prev.priorityQueueOpen.sort(function (a, b) {
                                      return b.f - a.f;
                                    }));

                                  case 5:
                                    prev.tableValue[successor.index] = successor.f;
                                    que = prev.priorityQueueOpen;
            ...
            case 1:
              ...
              _context4.next = 4;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_loop2());
...
//# sourceMappingURL=index.js.0e6a8c56c671eb906041.hot-update.js.map