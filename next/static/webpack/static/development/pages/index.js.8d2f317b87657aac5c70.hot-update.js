  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "pathfinding", function () {
      var _loop2 = function _loop2() {
        var q = void 0,
            index = void 0;
        console.log(_this.state.priorityQueueOpen[0]);

        for (var i = 0; i < _this.state.priorityQueueOpen[i].length; i++) {
          console.log(_this.state.priorityQueueOpen[i]);

          if (!q || _this.state.priorityQueueOpen[i].f < q.f) {
            console.log("ok");
            q = JSON.stringifythis.state.priorityQueueOpen[i];
            index = i;
          }
        }
...
//# sourceMappingURL=index.js.8d2f317b87657aac5c70.hot-update.js.map