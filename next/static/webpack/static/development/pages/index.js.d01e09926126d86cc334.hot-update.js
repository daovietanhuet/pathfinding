...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "pathfinding", function () {
      //while (this.state.priorityQueueOpen.length !== 0) {
      // let q = this.state.priorityQueueOpen.pop()
      var q = _this.state.priorityQueueOpen[0];
      var x = q.index % 20;
      ...
      for (var i = x - 1; i < x + 2; i++) {
        for (var j = y - 1; j < y + 2; j++) {
          if (i >= 0 && j >= 0) {
            ...
            successor.g = q.g + 1;
            successor.h = Math.sqrt(Math.pow(i - _this.state.chooseIndex % 20, 2) + Math.pow(i - _this.state.chooseIndex % 20, 2));
          } else continue;
        }
      } //}
...
//# sourceMappingURL=index.js.d01e09926126d86cc334.hot-update.js.map