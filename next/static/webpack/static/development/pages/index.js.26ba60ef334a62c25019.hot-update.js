...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "pathfinding", function _callee2() {
      var q, index, _i3, x, y, child, _i4, j, successor;
            ...
            case 0:
              ...
              for (_i3 = 0; _i3 < _this.state.priorityQueueOpen.length; _i3++) {
                if (!q || _this.state.priorityQueueOpen[_i3].f < q.f) {
                  q = {};
                  q = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()(q, _this.state.priorityQueueOpen[_i3]);
                  index = _i3;
                }
              }

              _this.setState({
                path: _this.state.path[i]
              });
              ...
              child = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
...
//# sourceMappingURL=index.js.26ba60ef334a62c25019.hot-update.js.map